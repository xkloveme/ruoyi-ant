      ...
      <a-row :gutter="24">
        <a-col :xl="16" :lg="24" :md="24" :sm="24" :xs="24">
          <a-card :bordered="false" title="RuoYi Cloud">
            <<<<<<< HEAD
            <p><strong>Spring Cloud</strong> 版本的若依,集成 <strong>Spring Cloud</strong> 的几大神兽: <strong>eureka,gateway,hystrix,feign,config... </strong>自定义token实现授权，直接存到redis,集成工作activiti,另有nacos版本</p>
            ...
            =======
            <p>
              <strong>Spring Cloud</strong> 版本的若依,集成
              <strong>Spring Cloud</strong> 的几大神兽:
              <strong>eureka,gateway,hystrix,feign,config...</strong>自定义token实现授权，直接存到redis,集成工作activiti,另有nacos版本
            </p>
            <p>
              <strong>文档地址</strong>
              <a href="http://doc.rycloud.zmrit.com" target="_blank">http://doc.rycloud.zmrit.com</a>
            </p>
            <p>
              <strong>RuoYi Cloud</strong> 承诺永久开源，不会出商业版之类的东西
            </p>
            <p>
              <strong>RuoYi Cloud</strong> 是采用 MIT 许可的开源项目，使用完全免费。 但为了项目能够健康持续的发展下去，我们期望获得相应的资金支持。 你可以通过下列的方法来赞助我们的开发。
            </p>
            ...
            <p>
              <strong>Spring Cloud 从零开始免费教程</strong>
              <a
                href="http://club.zmrit.com/cloud-zero/"
                target="_blank"
              >http://club.zmrit.com/cloud-zero/</a>
            </p>
          </a-card>
        ...
        <a-col
          ...
          >
            <h3 style="margin: 12px 26px">【年中618，云产品0.9折起】口碑爆款，云服务器低至89.8元/年</h3>
            <ul>
              <li>
                <h4>ECS突发性能型t5</h4>
              </li>
            ...
            <a href="https://www.aliyun.com/activity/618/index?userCode=p88vtdla" target="_blank">
          ...
          <a-card title="联系信息" :bordered="false">
            <a-row>
              ...
              <a-col :span="20">
                <a href="https://jq.qq.com/?_wv=1027&k=5JGXHPD" target="_blank">
                  <a-button type="primary" size="small">755109875</a-button>
                </a> 点击按钮入群
              </a-col>
            </a-row>
          </a-card>
